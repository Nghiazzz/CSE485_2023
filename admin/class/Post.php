			...
			foreach($data as $item){
				if($item['status']=='published'){
					...
					<tr>
						...
						<button type='button' class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#abc{$item['id']}'>
						DELETE
						</button>

						<!-- Modal -->
						<div class='modal fade'id='abc{$item['id']}' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
